...
import (
	...
	"github.com/go-unity/framework/contracts/console/command"
	"github.com/go-unity/framework/support/file"
	"github.com/go-unity/framework/support/str"
)
...
func (receiver *SeederMakeCommand) getPath(name string) string {
	...
	return filepath.Join(pwd, "database", "seeders", str.Camel2Case(folderPath), str.Camel2Case(modelName)+".go")
}
